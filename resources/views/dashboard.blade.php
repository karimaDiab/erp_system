<x-app-layout :title="__('app.nav_dashboard')">
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <a href="{{ route('products.index') }}" class="mt-4 inline-block text-sm font-semibold text-[#3A306F] hover:underline">{{ __('app.view_all') }}</a>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <a href="{{ route('sales-orders.index') }}" class="mt-4 inline-block text-sm font-semibold text-[#3A306F] hover:underline">{{ __('app.view_all') }}</a>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <a href="{{ route('purchase-orders.index') }}" class="mt-4 inline-block text-sm font-semibold text-[#3A306F] hover:underline">{{ __('app.view_all') }}</a>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <a href="{{ route('production-orders.index') }}" class="mt-4 inline-block text-sm font-semibold text-[#3A306F] hover:underline">{{ __('app.view_all') }}</a>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <a href="{{ route('customers.index') }}" class="mt-4 inline-block text-sm font-semibold text-[#3A306F] hover:underline">{{ __('app.view_all') }}</a>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6">
            ...
            <a href="{{ route('suppliers.index') }}" class="mt-4 inline-block text-sm font-semibold text-[#3A306F] hover:underline">{{ __('app.view_all') }}</a>
        </div>
    </div>
</x-app-layout>
