<x-app-layout :title="__('app.nav_products')">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('products.create') }}" class="rounded-lg bg-[#3A306F] px-4 py-2 text-sm font-semibold text-white hover:bg-[#2f2759]">
            + {{ __('app.add_new') }}
        </a>
    </div>
                ...
                @forelse ($products as $product)
                    <tr>
                        ...
                        <td class="px-6 py-3 text-end">
                            <a href="{{ route('products.edit', $product) }}" class="font-medium text-[#3A306F] hover:underline">{{ __('app.edit') }}</a>
